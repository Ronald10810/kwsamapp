...
import aiToolsRoutes, { regionalAdminHistoryHandler } from './routes/aiTools.js';
import listingTransferRoutes from './routes/listingTransfer.js';
import agentTransferRoutes from './routes/agentTransfer.js';
...
app.get('/api/ai-tools/regional-admin-history', requireAuth, resolvePermissions, async (req, res) => {
  await regionalAdminHistoryHandler(req as Parameters<typeof regionalAdminHistoryHandler>[0], res as Parameters<typeof regionalAdminHistoryHandler>[1]);
});
app.use('/api/ai-tools', aiToolsRoutes);
app.use('/api/listing-transfer', listingTransferRoutes);
app.use('/api/agent-transfer', agentTransferRoutes);
