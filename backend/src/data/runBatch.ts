...
function optArg(flag: string, fallback: string): string {
...
function runBatchSummary(batchPrefix: string, publishLegacy: boolean, dryRunPublish: boolean, skipImport: boolean): void {
  console.log('============================================================');
...
function validateRequiredFiles(filePaths: string[]): void {
