...
describe('public listings featured ordering regression guard', () => {
    ...
    it('prioritizes associate featured listings when kwuid is provided', async () => {
        ...
        const [totalSql, totalParams] = queryMock.mock.calls[1];
        ...
        const [listSql, listParams] = queryMock.mock.calls[2];
...
//# sourceMappingURL=public.featured-listings-regression.test.js.map