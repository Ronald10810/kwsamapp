...
function resolveCapAmount(cap, manualCap) {
    if (manualCap > 0)
        return manualCap;
    if (cap > 0)
        return cap;
...
async function fetchRawRows(db) {
