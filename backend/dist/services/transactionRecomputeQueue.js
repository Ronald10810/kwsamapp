    ...
    try {
        ...
        if (process.platform === 'win32') {
            try {
                ...
                console.error('[recompute-queue] failed to start recompute (fallback):', fallbackError instanceof Error ? fallbackError.message : fallbackError);
...
export function scheduleTransactionAgentRecompute(trigger) {
    if (recomputeRunning) {
...
//# sourceMappingURL=transactionRecomputeQueue.js.map