...
const PdfParseClass = typeof pdfParseModule?.PDFParse === 'function'
    ...
    : null;
export async function generateCmaData({ formData, loomReportBuffer, loomReportOriginalName, }) {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
async function requestCmaResponse(client, systemPrompt, userPrompt) {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function parseCmaResponse(response) {
...
function needsPortalCoverageRetry(listings) {
...
function buildUserPrompt(formData, loomReportOriginalName, loomReportText) {
...
async function extractPdfText(buffer) {
    ...
    if (!cleanedText) {
        throw new Error('The uploaded PDF could not be read. Please try a clearer PDF export of the Loom report.');
    }
...
//# sourceMappingURL=openai-cma.js.map