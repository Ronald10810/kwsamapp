...
describe('scoped TAC dry-run args', () => {
    ...
    it('blocks write mode flags', () => {
        expect(() => parseScopedDryRunArgsForTesting(['--write'])).toThrow('Write mode is blocked. Scoped recalculation currently supports dry-run only.');
    });
});
//# sourceMappingURL=recalculateTransactionAgentCalculationsScopedDryRun.test.js.map