...
export default function TopDownAgentReport() {
  ...
  useEffect(() => {
    ...
    async function loadOptions(): Promise<void> {
      try {
        ...
        const scopedMcId = isMarketCenterContext
  ...
  useEffect(() => {
    ...
    void loadReport();
  }, [loadReport, hasInitializedFilters]);
  ...
  function resetFiltersToDefaults(): void {
    ...
    const scopedMcId = isMarketCenterContext
      ? resolveScopedMarketCenterId(options.market_centers, activeContext?.marketCenterId, activeContext?.marketCenter)
      : '';
